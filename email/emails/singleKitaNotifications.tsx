...
interface SingleKitaNotificationsEmailProps {
  kitaName: string;
  consentId: string;
}
...
> = ({ kitaName, consentId }) => (
  ...
  >
    <Section style={styles.box}>
      ...
      <Paragraph>
        Sollten wieder Plätze in dieser Tageseinrichtung frei werden, erhalten
        Sie von uns schnell einen Hinweis. Sie können sich jederzeit für
        Benachrichtigungen für weitere Kitas anmelden.
      </Paragraph>
      <Button
        pX={20}
        pY={14}
...
export default SingleKitaNotificationsEmail;
